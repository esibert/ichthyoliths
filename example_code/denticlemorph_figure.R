###########################################
#                                         #
#     Publication Figure for Denticles    #
#     Manuscript, including workflow      #
...
dentdat <- read.csv('example_code/Blank Copy of Denticles Sheet - V0.5_Morphotypes.csv', skip = 1, header = TRUE, blank.lines.skip = TRUE)
...
##### Figure for manuscript - Ridge system type #####
